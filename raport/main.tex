...
Nu när det finns nummer knappar och ett sätt att se vilket nummer man har skrivit så behövs det ett sätt att säga till programmet vad numret betyder. Numret som har skrivits in kan vara en av tre saker. 
...
Antal är som sagt tidigare en attribut hos produkter och betalningar. Antal för den senaste produkten eller betslingen kan ändras men plus och minus knapparna (se figur \ref{fig:3alt}).
När man trycker på en av antals knapparna så kollar programmet om num är noll; ifall num är noll så lägger den till eller tar bort en av antalet på den senaste
